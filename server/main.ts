...
import defaultPrompts from '../shared/default-prompts.json' with { type: 'json' };

const DEFAULT_BAD_CRITERIA = defaultPrompts.badCriteria;
const DEFAULT_GOOD_CRITERIA = defaultPrompts.goodCriteria;
const DEFAULT_HIGHLIGHT_CRITERIA = defaultPrompts.highlightCriteria;
